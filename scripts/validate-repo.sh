...
for sanity_script in "$repo_root/scripts/bug-killer-sanity.sh" "$repo_root/scripts/clear-prd-sanity.sh" "$repo_root/scripts/multi-path-debug-sanity.sh" "$repo_root/scripts/se-good-plan-sanity.sh"; do
