...
- `se-good-plan`：面向软件工程计划写作与审查的 skill，生成分阶段、可执行、可验证、可审查、可回滚，并带 plan-to-code 完整性证据、收益验收和链路关键状态日志证据的软件工程计划
...
- `threejs-game` 及 `threejs-game-*`：面向 three.js 游戏开发的 skill family，覆盖运行时、资产、渲染、输入、交互、物理、动画、VFX、性能、存档网络、XR 与 QA 发布
