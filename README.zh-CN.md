...
- `provider-switch`：统一维护多个 Agent 与模型 Provider 的临时配置、安全安装、验证、备份和回滚；当前支持 Codex + DeepSeek V4 Flash、Claude Code + DeepSeek Pro/Flash 混合模式及 Claude Code 全 Flash 模式
