...
| `se-good-plan` | Write and review phased, executable, verifiable, reviewable, rollback-aware software engineering plans with plan-to-code completeness evidence for implementation, refactor, migration, rollout, bug-fix, performance, security, and DevOps work. | `npx skills add https://github.com/ceasarXuu/AstartesSkills --skill se-good-plan` |
...
release metadata formatting, and regression fixtures for required plan fields.
