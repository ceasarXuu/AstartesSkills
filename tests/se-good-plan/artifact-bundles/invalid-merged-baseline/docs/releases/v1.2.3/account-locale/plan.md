...
The full decision baseline was copied into the plan instead of remaining an independent authority.

## Design

Add an optional locale field through the existing account schema, update endpoint,
and settings form without adding a parallel account subsystem.
