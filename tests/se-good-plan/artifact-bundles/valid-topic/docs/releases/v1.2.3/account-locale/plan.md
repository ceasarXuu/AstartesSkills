...
and settings form. Null-compatible reads preserve D1, and reuse of the existing
account flow preserves D2. No new provider, service, or account subsystem is
introduced.
