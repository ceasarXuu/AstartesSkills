...
- Major: the one-second interruption benefit is claimed without a baseline, measurement method, or flow that can meet it because retries happen every two seconds.
